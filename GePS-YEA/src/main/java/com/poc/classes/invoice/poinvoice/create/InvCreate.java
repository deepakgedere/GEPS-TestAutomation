...
//TODO Constructor
    public InvCreate(PlaywrightFactory playwrightFactory, ILogin iLogin, Properties properties, Page page, ILogout iLogout, ICurrencyExchangeRate iCurrencyExchangeRate) {
        this.iLogin = iLogin;
